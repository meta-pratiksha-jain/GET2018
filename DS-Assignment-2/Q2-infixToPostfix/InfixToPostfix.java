...
public class InfixToPostfix {
    ...
    IStack<String> stack=new StackUsingLinkedList<String>();
    ...
    public String convertInfixToPostfix(String infixExpression)
    {
        ...
        for(String token:tokenArray)
        {
            ...
            else
            {
                ...
                //if token has lower precedence than operator at top of stack then operator of higher precedence is popped from stack and added to the postfix expression. 
    ...
    {
        String tokenAtTopOfStack=stack.peek();
     ...
     * @param token
     * @return returns true if operator at top of stack has higher precedence than token otherwise false
     */
     ...
     * @param token
     * @return returns true if token contain only alpha numeric character otherwise false
     */
