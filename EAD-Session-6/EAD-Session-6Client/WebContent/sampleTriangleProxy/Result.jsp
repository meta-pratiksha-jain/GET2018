...
<jsp:useBean id="sampleTriangleProxyid" scope="session" class="com.TriangleProxy" />
<%
...
case 2:
        ...
        double getArea2mtemp = sampleTriangleProxyid.getArea(side1_0idTemp,side2_1idTemp,side3_2idTemp);
