...
public class TriangleProxy implements com.Triangle {
  private String _endpoint = null;
  private com.Triangle triangle = null;
  ...
  private void _initTriangleProxy() {
    try {
      triangle = (new com.TriangleServiceLocator()).getTriangle();
      if (triangle != null) {
        if (_endpoint != null)
  ...
  public com.Triangle getTriangle() {
    if (triangle == null)
      _initTriangleProxy();
    return triangle;
  }
